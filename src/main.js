document.addEventListener('DOMContentLoaded', function(){
    var datainput = document.getElementById(`request-input`)    
        ...
        var myData = { 
            ...
            summary:'<p>Executive leader with expertise in all facets of product development, project management and strategy execution. My career in business leadership allowed me to develop skills in collaborating with all organization members to achieve business and financial objectives. My skills and passion for achieving success, I have been instrumental in streamlining and improving processes, enhancing productivity, and implementing technology solutions.</p>', 
