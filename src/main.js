document.addEventListener('DOMContentLoaded', function(){
    var datainput = document.getElementById(`request-input`)    
        ...
        var myData = { 
            ...
            credits: '<p>Big thanks to <a href="https://github.com/ManzDev/twitch-manzdev-bios" target="_blank">ManzDev</a> for the development of the Award BIOS boot screen replica</p>',
        };
