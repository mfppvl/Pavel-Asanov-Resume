document.addEventListener('DOMContentLoaded', function(){
    var datainput = document.getElementById(`request-input`)    
        ...
        var myData = { 
            ...
            summary:'<p>Senior business operations executive with 20+ years of experience building and leading cross-functional and customer-focused teams in product innovation and entrepreneurial business initiatives. Deep success creating and managing a best-in-class organization leveraging highly disciplined business, financial, digital, data and analytic, and risk management acumen. Proven ability as a tactical and compelling communicator in both meeting room and large audience settings. Ability to assess complex and controversial subjects, create clarity, and ultimately drive to decisions. Discrete when handling confidential information.</p>', 
